...
const Svg = () => (
  <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1">
    ...
    <defs>
      <rect id="path-1" x="260" y="226" width="396" height="611" />
      <filter
        x="-0.9%"
        y="-0.9%"
        width="102.8%"
      ...
      <g id="甘特图-未设置" transform="translate(-648.000000, -515.000000)">
        ...
        <g id="矩形">
          <use
            ...
            id="#path-1"
          />
          <use fill="#FFFFFF" fillRule="evenodd" id="#path-2" />
        </g>
        <g id="数据配置" transform="translate(260.000000, 486.000000)" />
        <g id="数据配置" transform="translate(260.000000, 530.000000)" />
        <rect
          id="矩形"
          stroke="#ECEDF0"
          x="260.5"
